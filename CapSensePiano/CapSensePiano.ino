...
#define BUZZER_PIN      A3   // The output pin for the piezo buzzer
#define NUM_OF_SAMPLES  10   // Higher number whens more delay but more consistent readings
#define CAP_THRESHOLD   650  // Capactive reading that triggers a note (adjust to fit your needs)
...
int notes[]={NOTE_F4}; // C-Major scale
